...
1 INTRODUÇÃO
A Interação Humano-Computador (IHC) representa uma área fundamental da
Computação, especialmente diante da crescente digitalização dos serviços
públicos e educacionais no Brasil. Entre os anos de 2025 e 2035, diversos desafios
relacionados à inclusão digital, acessibilidade e ética em sistemas computacionais
têm sido discutidos pela comunidade científica.
Neste contexto, os jogos sérios surgem como ferramentas educacionais relevantes
para promover conscientização social, aprendizagem interativa e inclusão digital. O
...
portais públicos. O modelo adapta recomendações internacionais do WCAG ao
contexto brasileiro.
O WCAG (Web Content Accessibility Guidelines) estabelece quatro princípios
...
simplificada;
• VLibras: plataforma desenvolvida pelo governo brasileiro para tradução
automática em Libras;
• Sistemas educacionais digitais: dificuldades relacionadas à ausência de contraste
...
O jogo apresenta desafios interativos relacionados à navegação acessível, leitura
por voz, contraste visual e uso exclusivo do teclado.
Storyboard do jogo:
...
acessíveis contribui diretamente para democratização do acesso à informação e
...
BRASIL. Governo Digital. eMAG – Modelo de Acessibilidade em Governo
Eletrônico. Disponível em: . Acesso em: 20 maio 2026.
W3C. Web Content Accessibility Guidelines (WCAG). Disponível em: . Acesso em:
20 maio 2026.
SOCIEDADE BRASILEIRA DE COMPUTAÇÃO. Grandes Desafios de Pesquisa
em Interação Humano-Computador no Brasil (2025-2035). Disponível em: . Acesso
em: 20 maio 2026.
VLIBRAS. Plataforma VLibras. Disponível em: . Acesso em: 20 maio 2026
